...
class TripleAxisSpectr:
    ...
    def get_angles_and_Q(self, hkle):
        ...
        Args:
            hkle (list): Array of the scattering vector and energy transfer [h, k, l, e]
    ...
    def get_spec_angles(self, hkle=None):
        ...
        Args:
            hkle (list, optional): [H, K, L, E] values. Defaults to None.
        ...
        H, K, L, E = hkle
        length, H, K, L, E = _cleanargs(H, K, L, E)
    ...
    def CalcResMatQ(self, Q, W):
        #For a momentum transfer Q and energy transfers W,  alculates the Cooper-Nathans or Popovici
        #resolution matrix RM and resolution prefactor R0 in the Q coordinate system.
        #Inputs:  Q : ndarray or list of ndarray; W : float or list of floats
        #Returns: [R0, RM] : list(float, ndarray) Resolution pre-factor (R0) and resolution matrix (RM)
        #Based on ResLib 3.4c, originally authored by A. Zheludev
        ...
        for ind in range(length):
            ...
            RM_ = np.copy(M)
            #print("M:")              # checked by dgc
            #print(M)
            #print("RM_:")            # checked by dgc
            #print(RM_)
    ...
    def ResConv(self, sqw, pref, nargout, hkle, METHOD='fix', ACCURACY=None, p=None, seed=None):
        #Numerically calculate the convolution of a user-defined cross-section function with the resolution function for a
        ...
        Myy = RMS[:, 1, 1]
        Myw = RMS[:, 1, 2]   #changed  by dgc, was 1, 3]
    ...
    def ResConvSMA(self, sqw, pref, nargout, hkle, METHOD='fix', ACCURACY=None, p=None, seed=None):
        ...
        #Inputs: sqw : cross section func; pref : prefactor and background func
        #
        #Returns: conv : array Calculated value of the cross section, folded with the resolution function
        #Based on ResLib 3.4c, originally authored by A. Zheludev
