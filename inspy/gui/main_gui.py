# -*- coding: utf-8 -*-
# This code is mondified from neutronpy
...
from inspy.instrument.tools import get_tau
...
class MainWindow(QMainWindow):
    ...
    def load_instrument(self):
        self.instrument = TripleAxisSpectr()
        ...
        self.edrop_dict = {'energy (meV)': float(self.energy_input.text()),
                           ...
                           'wavevector (A-1)': Energy(wavevector=float(self.energy_input.text())).energy}
        ...
        #self.instrument.ResolutionPlot(self.q)
