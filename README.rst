...
.. |mastertravis| image:: https://travis-ci.org/inspy/inspy.svg?branch=master
        :target: https://travis-ci.org/inspy/inspy

.. |masterappveyor| image:: https://ci.appveyor.com/api/projects/status/github/inspy/inspy?branch=master&svg=true
        :target: https://ci.appveyor.com/project/pseudocubic/inspy

.. |coverage| image:: https://codecov.io/gh/inspy/inspy/branch/master/graph/badge.svg
...
Installation
------------
It is recommended that you use `anaconda <https://www.continuum.io/downloads>`_ or ``pip`` to install inspy::
